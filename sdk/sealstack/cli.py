...
``sealstack export --format aerf bundle.json --signing-key seed.txt``
...
from sealstack.export import ARTIFACT_SUFFIX, BUILDERS, FORMATS, Export, ExportError
from sealstack.identity import DirectoryLock, IdentityStore
from sealstack.signing import SEED_LENGTH, b64url_decode
from sealstack.verify import Result, verify_bundle
...
def build_parser() -> argparse.ArgumentParser:
    """Build the ``sealstack`` command-line parser."""
